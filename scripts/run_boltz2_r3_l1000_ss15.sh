#!/bin/bash
# Run Boltz-2 Round 3 for casp16_l1000: step_scale=1.5 variant of R2
# Parameters: diffusion_samples=5, step_scale=1.5 (R2 was 1.2), 10 seeds, no affinity
# Goal: isolate step_scale effect vs diffusion_samples=5×10seeds effect
# GPU 0
...
OUTPUT_BASE="${PROJECT_ROOT}/outputs/boltz2/casp16_l1000_r3_ss15"
CACHE_DIR="${PROJECT_ROOT}/weights/boltz"

# Parameters
DIFFUSION_SAMPLES=5
STEP_SCALE=1.5     # ← changed from R2 (1.2)
MODEL="boltz2"
RECYCLING_STEPS=10
SAMPLING_STEPS=200
...
echo "=== Boltz-2 Round 3 (L1000, step_scale=1.5) ==="
...
echo ""
echo "=== Boltz-2 R3 L1000 complete ==="
