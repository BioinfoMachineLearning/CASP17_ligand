#!/bin/bash
# Run Boltz-2 Round 2 for casp16_l2000_struct: 10 seeds × 5 diffusion_samples = 50 models per target
...
INPUT_DIR="${PROJECT_ROOT}/data/test_cases/casp16_l2000_struct/boltz2_inputs"
OUTPUT_BASE="${PROJECT_ROOT}/outputs/boltz2/casp16_l2000_struct_r2"
...
echo "=== Boltz-2 Round 2 (L2000 struct, 2 targets) ==="
